...
app.config['UPLOAD_FOLDER'] = 'S:\\image content recognizer\\pages\\static\\uploads'
...
def home_html():
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            text = tess.image_to_string(PIL.Image.open(f"S:\\image content recognizer\\pages\\static\\uploads\\{filename}"))
